...
export const useConferenceStore = defineStore('conference', {
  ...
  getters: {
    ...
    availableYears(state) {
      if (!state.selectedConference || !state.localData[state.selectedConference]) {
        return []
      }
    ...
    selectedConferenceName(state) {
      ...
      return state.conferences[state.selectedConference] || state.selectedConference.toUpperCase()
    },
